...
5. `ohder-finding-resolution-runtime.md`: OHDER finding evidence, false-positive adjudication, and record-only resolution workflow
6. `future-ohder-runtime.md`: current, partial, planned, and future OHDER capability boundaries
