  ...
  return {
    ...
    laws: [
      ...
      },
      {
        ...
        value: 'valid',
        outcome: 'block',
        message: 'Single source of truth integrity must remain valid.',
      },
      {
      ...
      },
      {
        ...
        value: 'valid',
        outcome: 'block',
        message: 'Security boundary must remain valid.',
      },
      {
        ...
        value: 'valid',
        outcome: 'block',
        message: 'Layer isolation must remain valid.',
      },
      {
        ...
        value: 'valid',
        outcome: 'block',
        message: 'Runtime synchronization must remain event-only.',
      },
      {
        ...
        value: 'valid',
        outcome: 'block',
        message: 'Durability integrity must remain valid.',
      },
      {
